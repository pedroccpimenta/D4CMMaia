...
for i in range(0, 5):
	...
	menu["opção"]=" "
	menu["sobremesa"]=linha[34+4*i]
	day.append({"weekday":linha[1+6*i], "menu":menu})

	menuhtml=menuhtml+"<tr><td>"+linha[1+6*i]
	menuhtml=menuhtml+"<td>"+linha[31+4*i]
	menuhtml=menuhtml+"<td>"+linha[32+4*i]
	menuhtml=menuhtml+"<td>"+linha[33+4*i]
	menuhtml=menuhtml+"<td>"+linha[33+4*i]
	menuhtml=menuhtml+"<td>"+linha[35+4*i]
...
menuhtml=menuhtml+"<hr color=lime>Fonte: Albertina Ferreira<br>email: <a href=mailto:albertina.ferreira@smasmaia.pt?subject='pedido de reserva'>albertina.ferreira@smasmaia.pt</a><br>telef: <a href=tel:+351229430800>+351229430800</a>"
...
menuhtml=menuhtml+"<br>Maps: <a href='https://www.google.com/maps/@41.23,-8.6227,15z'>Google</a>"

menuhtml=menuhtml+"<br><img src='"+img["url"]+"' width='100%' title='"+img["description"]+"'>"
