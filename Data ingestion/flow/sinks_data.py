...
# URL TO GET SINKS DATA
host_w = "https://93.102.140.115:8080/cubes/0/analytics/0/sinks/data"
...
open(r"C:\Users\cmm1490\Documents\!MAIN\Projetos\Repositórios Git\Yunex-Data-Pipeline\Data export\sinks_data.txt", "w").write(req.text)
