...
# URL TO GET COUNTS
host_w = "https://93.102.140.115:8080/cubes/0/analytics/0/counts"
...
seqnumber = {
    "sequence_number" : "144",
    "cache_start_timestamp": "1657275232000"
}
...
req = requests.post(host_w, headers=headers, json=seqnumber, verify=False)
...
open(r"C:\Users\cmm1490\Documents\!MAIN\Projetos\Repositórios Git\Yunex-Data-Pipeline\Data export\counts.txt", "w").write(req.text)
