...
# URL TO CAMERA FRAME
host_w = "https://93.102.140.115:8080/cubes/0/analytics/0/camera_frame"
...
cframe = {
    "last_image_timestamp" : "1666001546820",
    "requested_size" : {
        "height": 720,
        "width": 1280
    }
...
req = requests.post(host_w, headers=headers, json=cframe, verify=False)
...
open(r"C:\Users\cmm1490\Documents\!MAIN\Projetos\Repositórios Git\Yunex-Data-Pipeline\Data export\camera_frame.txt", "w").write(req.text)
