...
host_w = "https://93.102.140.115:8080/users/auth"
...
# POST CALL TO THE END POINT
req = requests.post(host_w, headers=headers, json=userId, verify=False)
...
open(r"C:\Users\cmm1490\Documents\!MAIN\Projetos\Repositórios Git\Yunex-Data-Pipeline\Data export\auth_token.txt", "w").write(req.text)
